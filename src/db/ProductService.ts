...
class ProductService {
	...
	parse: IParse = ({
		...
		product: {
			...
			numberOfOngoingOrders: Number(numberOfOngoingOrders),
			numberOfReviews: Number(numberOfReviews),
			numberOfSales: Number(numberOfSales),
			price: Number(price),
		...
		model: {
			...
			cameraX: Number(cameraPosition.x),
			cameraY: Number(cameraPosition.y),
			cameraZ: Number(cameraPosition.z),
		},
		series: series,
		features: features,
